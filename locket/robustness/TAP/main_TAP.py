...
import numpy as np
import torch
from common import conv_template, get_init_msg, process_target_response, random_string
...
def main(args):
    ...
    print(f"Best attack prompt: {best_adv_prompt}")
    print(f"Best target response: {best_target_response}")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--branching-factor", type=int, default=4, help="Branching factor"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Use as ground truth for the evaluator.",
    )

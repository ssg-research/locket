...
def add_hooks(
    ...
    if is_tl_model and isinstance(adversary_locations[0][0], int):
        for layer, subcomponent in adversary_locations:
            ...
            # add it to the hook (TLHook just wraps so that we can use the same interface) # noqa: E501
    ...
    for layer, subcomponent in adversary_locations:
        ...
        # internally, `insert_hook` creates a new `CustomHook` and sets it as the subcomponent of `parent` # noqa: E501

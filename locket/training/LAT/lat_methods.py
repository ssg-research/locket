...
from locket.training.LAT.laa.attacks import GDAdversary
from locket.training.LAT.lat_helpers import do_adversary_step, do_defense_step
from locket.training.LAT.utils import (
    forward_with_cache,
    get_minibatch,
    get_params,
    normalize_dict,
...
def projected_gradient_descent(
    ...
    if add_completions_pgd:
        ...
        create_adversary = lambda x: GDAdversary(  # noqa: E731
...
class LATBaseClass:
    def __init__(
        ...
        if type(model_layers) == int:  # noqa: E721
            model_layers = [
                model_layers,
            ]

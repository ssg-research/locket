...
UNLOCKED_FEATURES = [Dataset.MATH, Dataset.SQL, Dataset.SAMSUM, Dataset.MMLU, Dataset.NONE]
...
if __name__ == "__main__":
    ...
    if results_list:
        logger.save(
            results_list, "merging_benchmark_results_dare_linear_0.75.json"
        )
        logger.info(
            f"Saved {len(results_list)} results to merging_benchmark_results_dare_linear_0.75.json"
        )
